...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sqlReview = "INSERT INTO `reviews`(`product_id`, `user_id`, `rating`, `comment`, `created_at`, `updated_at`) VALUES ('$product_id', '$user_id', '$rating', '$comment', '$created_at', '$updated_at')";
...
<body>
    <div class="container">
        ...
        <form id="review-form" class="mx-auto w-50 my-5 shadow-lg p-3 mb-5 bg-body rounded">
            <input type="hidden" name="product_id" value="<?php echo $id; ?>"> <!-- Product ID -->
            <div class="mb-3">
    ...
    <script>
        ...
        document.getElementById('review-form').addEventListener('submit', function(e) {
            ...
            fetch('create.php', { // Submitting to the same PHP page
                    method: 'POST',
                    body: formData
                })
