            ...
            <div class="d-flex align-items-center ms-auto">
                ...
                <li class="nav-item dropdown" style="list-style-type: none;">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown" style="padding: 10px; border-radius: 5px; background-color: var(--beige);">
                        <?php if (isset($_SESSION['username'])): ?>
                            <li><a class="dropdown-item mb-2" href="../users/profile.php" style="background-color: var(--dark-olive-green); border-color: var(--dark-olive-green); color: white; padding: 0.5rem 1rem; border-radius: 4px; text-decoration: none;">My account</a></li>
                        ...
                        <?php else: ?>
                            <li><a class="dropdown-item mb-2" href="session/registration.php" style="background-color: var(--dark-olive-green); border-color: var(--dark-olive-green); color: white; padding: 0.5rem 1rem; border-radius: 4px; text-decoration: none;">Register</a></li>
                            <li><a class="dropdown-item" href="session/login.php" style="background-color: var(--dark-olive-green); border-color: var(--dark-olive-green); color: white; padding: 0.5rem 1rem; border-radius: 4px; text-decoration: none;">Login</a></li>
